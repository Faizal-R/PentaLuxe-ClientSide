  ...
  return (
    <div>
      <div className="heading text-center">
        ...
        <p className="">
          Explore our exquisite collection of Attars, known for their rich,
          long-lasting fragrances crafted from natural ingredients.
        </p>
      </div>

      <div className="flex justify-center gap-10 px-10 mb-10 mt-5 text-center mx-auto">
        {(displayProducts.length > 0 ? displayProducts : products).map(
          (product) => (
